      ...
      <div className="max-w-[628px] grid gap-8 text-[#556070]">
        ...
        <div>
          ...
          <p className="text-[#505050] text-[24px] font-normal">
            ...
            effortless. Enterprise design isn’t just about functionality, it’s
            about clarity, speed, and trust.
          </p>
        </div>
        <div>
          <h2 className="text-[#1A1A1A] font-medium text-[24px]">
        ...
        <div>
          ...
          <p className="text-[#505050] text-[24px] font-normal">
            ...
            scratch. If it’s meaningful work with good people, I’m interested.
          </p>
        </div>
        <div>
          <h2 className="text-[#1A1A1A] font-medium text-[24px]">
