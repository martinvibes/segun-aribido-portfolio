    ...
    <div className="flex flex-col lg:flex-row lg:justify-between gap-6 sm:gap-8 lg:gap-10 items-start my-12 sm:my-16 md:my-20 max-w-full box-border">
      ...
      <div className="w-full lg:w-[528px] xl:w-[628px] lg:shrink-0 grid gap-6 sm:gap-7 md:gap-8 text-[#556070] max-w-full box-border min-w-0">
        <div className="wrap-break-word">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal mt-2 wrap-break-word font-helvetica400">
        ...
        <div className="wrap-break-word">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 wrap-break-word font-helvetica400">
        ...
        <div className="wrap-break-word">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 wrap-break-word">
