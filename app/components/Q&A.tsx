  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between gap-6 sm:gap-8 lg:gap-10 items-start my-12 sm:my-16 md:my-20 max-w-full box-border">
      <div className="w-full lg:w-[383px] lg:shrink-0 lg:sticky lg:top-[130px] lg:self-start max-w-full box-border">
        ...
        <h4 className="text-[#556070] text-base sm:text-lg lg:text-[18px] mt-2 break-words">
      ...
      <div className="w-full lg:w-[528px] xl:w-[628px] lg:shrink-0 grid gap-6 sm:gap-7 md:gap-8 text-[#556070] max-w-full box-border min-w-0">
        <div className="break-words">
          <h2 className="text-[#1A1A1A] font-medium text-lg sm:text-xl md:text-2xl lg:text-[24px] break-words">
            What Kind of projects can I take on?
          </h2>
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal mt-2 break-words">
            I work on digital products that improve everyday experiences, from
            apps and dashboards to design systems. Whether it&apos;s a nonprofit
            tool or a startup MVP, I focus on clarity, usability, and craft.
          </p>
        </div>
        <div className="break-words">
          <h2 className="text-[#1A1A1A] font-medium text-lg sm:text-xl md:text-2xl lg:text-[24px] break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal mt-2 break-words">
            ...
            insights into clear design goals, prototypes, and a roadmap that
            aligns your mission with measurable outcomes. Collaboration is key;
            we build together, not in silos.
          </p>
        </div>
        <div className="break-words">
          <h2 className="text-[#1A1A1A] font-medium text-lg sm:text-xl md:text-2xl lg:text-[24px] break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 break-words">
            ...
            and then translate those insights into interfaces that are simple,
            accessible, and beautiful to use.
          </p>
        </div>
        <div className="break-words">
          <h2 className="text-[#1A1A1A] font-medium text-lg sm:text-xl md:text-2xl lg:text-[24px] break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 break-words">
            ...
            scale-ups, I focus on optimization: tightening design systems,
            improving workflows, and helping teams ship faster without losing
            quality.
          </p>
        </div>
        <div className="break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 break-words">
            Definitely. I&apos;ve worked on large-scale digital products used
            across organizations, from admin dashboards and reporting tools to
            field-level mobile apps. I focus on creating systems that improve
            efficiency, reduce cognitive load, and make complex workflows feel
            effortless. Enterprise design isn&apos;t just about functionality,
        ...
        <div className="break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 break-words">
            ...
            variables, design systems, and tools like Storybook or Zeplin to
            keep implementation seamless. Good communication and shared
            ownership make delivery faster and cleaner.
          </p>
        </div>
        <div className="break-words">
          <h2 className="text-[#1A1A1A] font-medium text-lg sm:text-xl md:text-2xl lg:text-[24px] break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 break-words">
            Yes, I&apos;m open to freelance and contract projects. I love
            joining teams that need hands-on design help, whether that&apos;s
            refining a product, building a design system, or bringing an idea to
            life from scratch. If it&apos;s meaningful work with good people,
            I&apos;m interested.
          </p>
        </div>
        <div className="break-words">
          ...
          <p className="text-[#505050] text-base sm:text-lg md:text-xl lg:text-[24px] font-normal font-helvetica400 mt-2 break-words">
            ...
            of design human-led. I use AI to handle repetitive tasks and uncover
            insights, freeing more time for strategy, storytelling, and
