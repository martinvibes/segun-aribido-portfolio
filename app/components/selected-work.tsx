            ...
            >
              ...
              <div className="py-4 sm:py-5 px-4 sm:px-6 md:px-7">
                ...
                <div className="mt-6 sm:mt-8 md:mt-10 mb-2">
                  <Link
                    href={data.link}
                    className="flex border font-normal font-helvetica400 border-[#132238] cursor-pointer items-center w-fit py-2 px-3 sm:px-4 text-[#132238] gap-2 sm:gap-3 rounded-lg text-sm sm:text-base"
                  >
