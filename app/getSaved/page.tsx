...
export default function Page() {
  return (
    <main className="my-6 sm:my-8 md:my-10 flex flex-col gap-8 sm:gap-12 md:gap-16 lg:gap-20 mb-12 sm:mb-16 md:mb-24 lg:mb-60 max-w-full overflow-x-hidden box-border">
